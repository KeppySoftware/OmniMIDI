...
namespace OmniMIDIMixerWindow
{
    class MeterFunc
    {
        ...
        public static void EnableLEDs()
        {
            ...
            OmniMIDIMixerWindow.Delegate.LED.BackColor = Color.Black;
            OmniMIDIMixerWindow.Delegate.LV1.BackColor = Color.Lime;
            OmniMIDIMixerWindow.Delegate.LV2.BackColor = Color.Lime;
            OmniMIDIMixerWindow.Delegate.LV3.BackColor = Color.Lime;
            OmniMIDIMixerWindow.Delegate.LV4.BackColor = Color.Lime;
            OmniMIDIMixerWindow.Delegate.LV5.BackColor = Color.Lime;
            ...
            OmniMIDIMixerWindow.Delegate.LV12.BackColor = Color.LightGreen;
            OmniMIDIMixerWindow.Delegate.LV13.BackColor = Color.Yellow;
            ...
            OmniMIDIMixerWindow.Delegate.LV17.BackColor = Color.Yellow;
            OmniMIDIMixerWindow.Delegate.LV18.BackColor = Color.Goldenrod;
            OmniMIDIMixerWindow.Delegate.LV19.BackColor = Color.Red;
            OmniMIDIMixerWindow.Delegate.LV20.BackColor = Color.Red;
            OmniMIDIMixerWindow.Delegate.LV21.BackColor = Color.Red;
            OmniMIDIMixerWindow.Delegate.LV22.BackColor = Color.Red;
            OmniMIDIMixerWindow.Delegate.RV1.BackColor = Color.Lime;
            OmniMIDIMixerWindow.Delegate.RV2.BackColor = Color.Lime;
            OmniMIDIMixerWindow.Delegate.RV3.BackColor = Color.Lime;
            OmniMIDIMixerWindow.Delegate.RV4.BackColor = Color.Lime;
            OmniMIDIMixerWindow.Delegate.RV5.BackColor = Color.Lime;
            ...
            OmniMIDIMixerWindow.Delegate.RV12.BackColor = Color.LightGreen;
            OmniMIDIMixerWindow.Delegate.RV13.BackColor = Color.Yellow;
            ...
            OmniMIDIMixerWindow.Delegate.RV17.BackColor = Color.Yellow;
            OmniMIDIMixerWindow.Delegate.RV18.BackColor = Color.Goldenrod;
            OmniMIDIMixerWindow.Delegate.RV19.BackColor = Color.Red;
            OmniMIDIMixerWindow.Delegate.RV20.BackColor = Color.Red;
            OmniMIDIMixerWindow.Delegate.RV21.BackColor = Color.Red;
            OmniMIDIMixerWindow.Delegate.RV22.BackColor = Color.Red;
            OmniMIDIMixerWindow.Delegate.Meter.Refresh();
        }
