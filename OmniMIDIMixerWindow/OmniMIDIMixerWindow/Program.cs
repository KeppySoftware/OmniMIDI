...
namespace OmniMIDIMixerWindow
{
    ...
    static class Program
    {
        ...
        {
            bool ok;
            BringToFrontMessage = WinAPI.RegisterWindowMessage("OmniMIDIMixerWindowToFront");
            m = new EventWaitHandle(false, EventResetMode.ManualReset, "OmniMIDIMixerWindow", out ok);
            if (!ok)
            {
            ...
            Application.Run(new OmniMIDIMixerWindow(args));
        }
    }
}
