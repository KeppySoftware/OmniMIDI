...
namespace OmniMIDIMixerWindow
{
    ...
    {
        public static RegistryKey ChanOverride = Registry.CurrentUser.OpenSubKey("SOFTWARE\\OmniMIDI\\ChanOverride", true);
            ...
            try
            {
                if (ImportDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    MessageBox.Show(
                        ...
                        "OmniMIDI - Import settings", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            catch (Exception ex)
            {
            ...
            try
            {
                if (ExportDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    MessageBox.Show(
                        ...
                        "OmniMIDI - Export settings", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            catch (Exception ex)
            {
        ...
        {
            if ((Int32)OmniMIDIMixerWindow.Settings.GetValue("MT32Mode", 0) == 1)
            {
