# Keppy's Direct MIDI API (KDMAPI) documentation
## What's KDMAPI?
KDMAPI is a group of calls, that allows you to bypass the Windows Multimedia API, thus getting rid of the lag caused by its slow buffer system.
