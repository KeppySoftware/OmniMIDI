/*
	...
	Original header: BASS 2.4 C/C++ header file
...
#define BASSVERSIONTEXTW	_T(BASSVERSIONTEXT)
...
extern BOOL(WINAPI* BASS_SetConfigPtr)(DWORD option, const void* value);
extern const void* (WINAPI* BASS_GetConfigPtr)(DWORD option);
extern DWORD(WINAPI* BASS_GetVersion)(void);
extern int (WINAPI* BASS_ErrorGetCode)(void);
...
#endif
extern BOOL(WINAPI* BASS_Free)(void);
extern BOOL(WINAPI* BASS_SetDevice)(DWORD device);
extern DWORD(WINAPI* BASS_GetDevice)(void);
extern BOOL(WINAPI* BASS_GetInfo)(BASS_INFO* info);
extern BOOL(WINAPI* BASS_Start)(void);
extern BOOL(WINAPI* BASS_Stop)(void);
extern BOOL(WINAPI* BASS_Pause)(void);
extern DWORD(WINAPI* BASS_IsStarted)(void);
extern BOOL(WINAPI* BASS_Update)(DWORD length);
extern float (WINAPI* BASS_GetCPU)(void);
extern BOOL(WINAPI* BASS_SetVolume)(float volume);
extern float (WINAPI* BASS_GetVolume)(void);
#if defined(_WIN32) && !defined(_WIN32_WCE) && !(defined(WINAPI_FAMILY) && WINAPI_FAMILY != WINAPI_FAMILY_DESKTOP_APP)
extern void* (WINAPI* BASS_GetDSoundObject)(DWORD object);
#endif

extern BOOL(WINAPI* BASS_Set3DFactors)(float distf, float rollf, float doppf);
extern BOOL(WINAPI* BASS_Get3DFactors)(float* distf, float* rollf, float* doppf);
...
extern HSAMPLE(WINAPI* BASS_SampleLoad)(BOOL mem, const void* file, QWORD offset, DWORD length, DWORD max, DWORD flags);
extern HSAMPLE(WINAPI* BASS_SampleCreate)(DWORD length, DWORD freq, DWORD chans, DWORD max, DWORD flags);
extern BOOL(WINAPI* BASS_SampleFree)(HSAMPLE handle);
extern BOOL(WINAPI* BASS_SampleSetData)(HSAMPLE handle, const void* buffer);
extern BOOL(WINAPI* BASS_SampleGetData)(HSAMPLE handle, void* buffer);
extern BOOL(WINAPI* BASS_SampleGetInfo)(HSAMPLE handle, BASS_SAMPLE* info);
extern BOOL(WINAPI* BASS_SampleSetInfo)(HSAMPLE handle, const BASS_SAMPLE* info);
extern DWORD(WINAPI* BASS_SampleGetChannel)(HSAMPLE handle, DWORD flags);
extern DWORD(WINAPI* BASS_SampleGetChannels)(HSAMPLE handle, HCHANNEL* channels);
extern BOOL(WINAPI* BASS_SampleStop)(HSAMPLE handle);

extern HSTREAM(WINAPI* BASS_StreamCreate)(DWORD freq, DWORD chans, DWORD flags, STREAMPROC* proc, void* user);
extern HSTREAM(WINAPI* BASS_StreamCreateFile)(BOOL mem, const void* file, QWORD offset, QWORD length, DWORD flags);
extern HSTREAM(WINAPI* BASS_StreamCreateURL)(const char* url, DWORD offset, DWORD flags, DOWNLOADPROC* proc, void* user);
extern HSTREAM(WINAPI* BASS_StreamCreateFileUser)(DWORD system, DWORD flags, const BASS_FILEPROCS* proc, void* user);
extern BOOL(WINAPI* BASS_StreamFree)(HSTREAM handle);
extern QWORD(WINAPI* BASS_StreamGetFilePosition)(HSTREAM handle, DWORD mode);
extern DWORD(WINAPI* BASS_StreamPutData)(HSTREAM handle, const void* buffer, DWORD length);
extern DWORD(WINAPI* BASS_StreamPutFileData)(HSTREAM handle, const void* buffer, DWORD length);

extern HMUSIC(WINAPI* BASS_MusicLoad)(BOOL mem, const void* file, QWORD offset, DWORD length, DWORD flags, DWORD freq);
extern BOOL(WINAPI* BASS_MusicFree)(HMUSIC handle);

extern BOOL(WINAPI* BASS_RecordGetDeviceInfo)(DWORD device, BASS_DEVICEINFO* info);
extern BOOL(WINAPI* BASS_RecordInit)(int device);
extern BOOL(WINAPI* BASS_RecordFree)(void);
extern BOOL(WINAPI* BASS_RecordSetDevice)(DWORD device);
extern DWORD(WINAPI* BASS_RecordGetDevice)(void);
extern BOOL(WINAPI* BASS_RecordGetInfo)(BASS_RECORDINFO* info);
extern const char* (WINAPI* BASS_RecordGetInputName)(int input);
extern BOOL(WINAPI* BASS_RecordSetInput)(int input, DWORD flags, float volume);
extern DWORD(WINAPI* BASS_RecordGetInput)(int input, float* volume);
extern HRECORD(WINAPI* BASS_RecordStart)(DWORD freq, DWORD chans, DWORD flags, RECORDPROC* proc, void* user);
...
extern DWORD(WINAPI* BASS_ChannelGetDevice)(DWORD handle);
extern BOOL(WINAPI* BASS_ChannelSetDevice)(DWORD handle, DWORD device);
extern DWORD(WINAPI* BASS_ChannelIsActive)(DWORD handle);
extern BOOL(WINAPI* BASS_ChannelGetInfo)(DWORD handle, BASS_CHANNELINFO* info);
extern const char* (WINAPI* BASS_ChannelGetTags)(DWORD handle, DWORD tags);
extern DWORD(WINAPI* BASS_ChannelFlags)(DWORD handle, DWORD flags, DWORD mask);
extern BOOL(WINAPI* BASS_ChannelLock)(DWORD handle, BOOL lock);
extern BOOL(WINAPI* BASS_ChannelFree)(DWORD handle);
...
extern BOOL(WINAPI* BASS_ChannelUpdate)(DWORD handle, DWORD length);
...
extern BOOL(WINAPI* BASS_ChannelSlideAttribute)(DWORD handle, DWORD attrib, float value, DWORD time);
extern BOOL(WINAPI* BASS_ChannelIsSliding)(DWORD handle, DWORD attrib);
extern BOOL(WINAPI* BASS_ChannelSetAttributeEx)(DWORD handle, DWORD attrib, void* value, DWORD size);
extern DWORD(WINAPI* BASS_ChannelGetAttributeEx)(DWORD handle, DWORD attrib, void* value, DWORD size);
extern BOOL(WINAPI* BASS_ChannelSet3DAttributes)(DWORD handle, int mode, float min, float max, int iangle, int oangle, float outvol);
extern BOOL(WINAPI* BASS_ChannelGet3DAttributes)(DWORD handle, DWORD* mode, float* min, float* max, DWORD* iangle, DWORD* oangle, float* outvol);
...
extern BOOL(WINAPI* BASS_ChannelGet3DPosition)(DWORD handle, BASS_3DVECTOR* pos, BASS_3DVECTOR* orient, BASS_3DVECTOR* vel);
...
extern DWORD(WINAPI* BASS_ChannelGetLevel)(DWORD handle);
extern BOOL(WINAPI* BASS_ChannelGetLevelEx)(DWORD handle, float* levels, float length, DWORD flags);
extern DWORD(WINAPI* BASS_ChannelGetData)(DWORD handle, void* buffer, DWORD length);
extern HSYNC(WINAPI* BASS_ChannelSetSync)(DWORD handle, DWORD type, QWORD param, SYNCPROC* proc, void* user);
extern BOOL(WINAPI* BASS_ChannelRemoveSync)(DWORD handle, HSYNC sync);
extern BOOL(WINAPI* BASS_ChannelSetLink)(DWORD handle, DWORD chan);
extern BOOL(WINAPI* BASS_ChannelRemoveLink)(DWORD handle, DWORD chan);
extern HDSP(WINAPI* BASS_ChannelSetDSP)(DWORD handle, DSPPROC* proc, void* user, int priority);
extern BOOL(WINAPI* BASS_ChannelRemoveDSP)(DWORD handle, HDSP dsp);
extern HFX(WINAPI* BASS_ChannelSetFX)(DWORD handle, DWORD type, int priority);
extern BOOL(WINAPI* BASS_ChannelRemoveFX)(DWORD handle, HFX fx);

extern BOOL(WINAPI* BASS_FXSetParameters)(HFX handle, const void* params);
extern BOOL(WINAPI* BASS_FXGetParameters)(HFX handle, void* params);
extern BOOL(WINAPI* BASS_FXSetPriority)(HFX handle, int priority);
extern BOOL(WINAPI* BASS_FXReset)(DWORD handle);
