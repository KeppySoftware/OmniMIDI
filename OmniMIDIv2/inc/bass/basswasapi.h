/*
	...
	Original header: BASSWASAPI 2.4 C/C++ header file
...
extern DWORD(WINAPI* BASS_WASAPI_GetVersion)();
extern BOOL(WINAPI* BASS_WASAPI_SetNotify)(WASAPINOTIFYPROC* proc, void* user);
extern BOOL(WINAPI* BASS_WASAPI_GetDeviceInfo)(DWORD device, BASS_WASAPI_DEVICEINFO* info);
extern float (WINAPI* BASS_WASAPI_GetDeviceLevel)(DWORD device, int chan);
extern BOOL(WINAPI* BASS_WASAPI_SetDevice)(DWORD device);
extern DWORD(WINAPI* BASS_WASAPI_GetDevice)();
extern DWORD(WINAPI* BASS_WASAPI_CheckFormat)(DWORD device, DWORD freq, DWORD chans, DWORD flags);
extern BOOL(WINAPI* BASS_WASAPI_Init)(int device, DWORD freq, DWORD chans, DWORD flags, float buffer, float period, WASAPIPROC* proc, void* user);
extern BOOL(WINAPI* BASS_WASAPI_Free)();
extern BOOL(WINAPI* BASS_WASAPI_GetInfo)(BASS_WASAPI_INFO* info);
extern float (WINAPI* BASS_WASAPI_GetCPU)();
extern BOOL(WINAPI* BASS_WASAPI_Lock)(BOOL lock);
extern BOOL(WINAPI* BASS_WASAPI_Start)();
extern BOOL(WINAPI* BASS_WASAPI_Stop)(BOOL reset);
extern BOOL(WINAPI* BASS_WASAPI_IsStarted)();
extern BOOL(WINAPI* BASS_WASAPI_SetVolume)(DWORD mode, float volume);
extern float (WINAPI* BASS_WASAPI_GetVolume)(DWORD mode);
extern BOOL(WINAPI* BASS_WASAPI_SetMute)(DWORD mode, BOOL mute);
extern BOOL(WINAPI* BASS_WASAPI_GetMute)(DWORD mode);
extern DWORD(WINAPI* BASS_WASAPI_PutData)(void* buffer, DWORD length);
extern DWORD(WINAPI* BASS_WASAPI_GetData)(void* buffer, DWORD length);
extern DWORD(WINAPI* BASS_WASAPI_GetLevel)();
extern BOOL(WINAPI* BASS_WASAPI_GetLevelEx)(float* levels, float length, DWORD flags);
