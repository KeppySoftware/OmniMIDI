...
namespace OmniMIDIConfigurator
{
    public partial class SoundFontInfo : Form
    {
        ...
        private void OmniMIDISoundfontInfo_Load(object sender, EventArgs e)
        {
            // LAL
        ...
        private void InitializeBASSMIDIStream()
        {
            ...
            hStream = BassMidi.BASS_MIDI_StreamCreateFile(MIDIPreview, 0L, 0L, 
                ...
                (OmniMIDIConfiguratorMain.Delegate.EnableSFX.Checked ? BASSFlag.BASS_DEFAULT : BASSFlag.BASS_MIDI_NOFX) |
                (LoopYesNo.Checked ? BASSFlag.BASS_SAMPLE_LOOP : BASSFlag.BASS_DEFAULT),
                0);
            Bass.BASS_ChannelSetAttribute(hStream, BASSAttribute.BASS_ATTRIB_MIDI_CPU, (int)(OmniMIDIConfiguratorMain.Delegate.MaxCPU.Value / 100));
        ...
        private void PreviewThread_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                Bass.BASS_Free();
                Bass.BASS_Init(-1, Convert.ToInt32(OmniMIDIConfiguratorMain.Delegate.Frequency.Text), BASSInit.BASS_DEVICE_LATENCY, IntPtr.Zero);
                ...
                Bass.BASS_SetConfig(BASSConfig.BASS_CONFIG_MIDI_VOICES, Convert.ToInt32(OmniMIDIConfiguratorMain.Delegate.PolyphonyLimit.Value));
        ...
        void ChangeWindowTitle(String Text)
        {
            if (!Quitting)
            {
                this.Invoke((MethodInvoker)delegate
                {
                    this.Text = String.Format("OmniMIDI - {0}", Text);
                });
            }
        }
