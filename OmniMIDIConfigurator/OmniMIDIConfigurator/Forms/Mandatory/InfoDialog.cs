...
namespace OmniMIDIConfigurator
{
    public partial class InfoDialog : Form
    {
        ...
        private String License = Environment.SystemDirectory + "\\OmniMIDI\\license.txt";
        ...
        private void InfoDialog_Load(object sender, EventArgs e)
        {
            ...
            if (!OmniMIDIConfiguratorMain.IsInternetAvailable) CFU.Visible = false;
        ...
        {
            Process.Start(System.Environment.GetEnvironmentVariable("USERPROFILE") + "\\OmniMIDI\\license.txt");
        }
        ...
        private void CTC_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                sb.Append(String.Format("OmniMIDI Information Dialog\n\n", DriverVer.Text));
