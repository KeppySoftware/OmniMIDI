...
namespace OmniMIDIConfigurator
{
    public partial class KeppySynthPitchShifting : Form
    {
        ...
        {
            if (Convert.ToInt32(OmniMIDIConfiguratorMain.Channels.GetValue(names[0], "0")) == 0)
            {
                CH1.Checked = false;
            }
            else
            ...
            if (Convert.ToInt32(OmniMIDIConfiguratorMain.Channels.GetValue(names[1], "0")) == 0)
            {
                CH2.Checked = false;
            }
            else
            ...
            if (Convert.ToInt32(OmniMIDIConfiguratorMain.Channels.GetValue(names[2], "0")) == 0)
            {
                CH3.Checked = false;
            }
            else
            ...
            if (Convert.ToInt32(OmniMIDIConfiguratorMain.Channels.GetValue(names[3], "0")) == 0)
            {
                CH4.Checked = false;
            }
            else
            ...
            if (Convert.ToInt32(OmniMIDIConfiguratorMain.Channels.GetValue(names[4], "0")) == 0)
            {
                CH5.Checked = false;
            }
            else
            ...
            if (Convert.ToInt32(OmniMIDIConfiguratorMain.Channels.GetValue(names[5], "0")) == 0)
            {
                CH6.Checked = false;
            }
            else
            ...
            if (Convert.ToInt32(OmniMIDIConfiguratorMain.Channels.GetValue(names[6], "0")) == 0)
            {
                CH7.Checked = false;
            }
            else
            ...
            if (Convert.ToInt32(OmniMIDIConfiguratorMain.Channels.GetValue(names[7], "0")) == 0)
            {
                CH8.Checked = false;
            }
            else
            ...
            if (Convert.ToInt32(OmniMIDIConfiguratorMain.Channels.GetValue(names[8], "0")) == 0)
            {
                CH9.Checked = false;
            }
            else
            ...
            if (Convert.ToInt32(OmniMIDIConfiguratorMain.Channels.GetValue(names[11], "0")) == 0)
            {
                CH12.Checked = false;
            }
            else
            ...
            if (Convert.ToInt32(OmniMIDIConfiguratorMain.Channels.GetValue(names[12], "0")) == 0)
            {
                CH13.Checked = false;
            }
            else
            ...
            if (Convert.ToInt32(OmniMIDIConfiguratorMain.Channels.GetValue(names[13], "0")) == 0)
            {
                CH14.Checked = false;
            }
            else
            ...
            if (Convert.ToInt32(OmniMIDIConfiguratorMain.Channels.GetValue(names[14], "0")) == 0)
            {
                CH15.Checked = false;
            }
            else
            ...
            if (Convert.ToInt32(OmniMIDIConfiguratorMain.Channels.GetValue(names[15], "0")) == 0)
            {
                CH16.Checked = false;
            }
            else
