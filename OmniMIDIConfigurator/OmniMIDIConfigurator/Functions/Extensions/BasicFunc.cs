                    ...
                    if (fileSize > lastReadLength)
                    {
                        using (var fs = new FileStream(filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite))
                        {
                            ...
                            while (true)
                            {
                                ...
                                OmniMIDIConfiguratorMain.Delegate.Invoke((MethodInvoker)delegate ()
                                {
                                    OmniMIDIConfiguratorMain.Delegate.DebugLogShow.AppendText(Environment.NewLine + text);
                                    OmniMIDIConfiguratorMain.Delegate.DebugLogShow.ScrollToCaret();
                                });
                            }
                        }
                    }
